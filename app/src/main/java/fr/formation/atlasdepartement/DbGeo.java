...
class DbGeo extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("INSERT INTO Regions (no_region, nom) VALUES (11,'ile-de-France')");
        ...
        db.execSQL("INSERT INTO Regions (no_region, nom) VALUES (93,'Provence-Alpes-Cote d''Azur')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('07','82','Ardeche','ARDECHE','5529','1790-03-04T12:00:00','Privas','http://fr.wikipedia.org/wiki/Ard%C3%A8che_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('08','21','Ardennes','ARDENNES','5229','1790-03-04T12:00:00','Charleville-Mezieres','http://fr.wikipedia.org/wiki/Ardennes_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('09','73','Ariege','ARIEGE','4890','1790-03-04T12:00:00','Foix','http://fr.wikipedia.org/wiki/Ari%C3%A8ge_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('13','93','Bouches-du-Rhone','BOUCHES DU RHONE','5087','1790-03-04T12:00:00','Marseille','http://fr.wikipedia.org/wiki/Bouches-du-Rh%C3%B4ne')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('16','54','Charente','CHARENTE','5956','1790-03-04T12:00:00','Angouleme','http://fr.wikipedia.org/wiki/Charente_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('19','74','Correze','CORREZE','5857','1790-03-04T12:00:00','Tulle','http://fr.wikipedia.org/wiki/Corr%C3%A8ze_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('21','26','Cote d''or','COTE D''OR','8763','1790-03-04T12:00:00','Dijon','http://fr.wikipedia.org/wiki/C%C3%B4te-d%27Or')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('22','53','Cotes d''armor','COTES D''ARMOR','6878','1790-03-04T12:00:00','St-Brieuc','http://fr.wikipedia.org/wiki/C%C3%B4tes-d%27Armor')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('23','74','Creuse','CREUSE','5565','1790-03-04T12:00:00','Gueret','http://fr.wikipedia.org/wiki/Creuse_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('24','72','Dordogne','DORDOGNE','9060','1790-03-04T12:00:00','Perigueux','http://fr.wikipedia.org/wiki/Dordogne_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('25','43','Doubs','DOUBS','5234','1790-03-04T12:00:00','Besancon','http://fr.wikipedia.org/wiki/Doubs_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('26','82','Drome','DROME','6530','1790-03-04T12:00:00','Valence','http://fr.wikipedia.org/wiki/Dr%C3%B4me_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('29','53','Finistere','FINISTERE','6733','1790-03-04T12:00:00','Quimper','http://fr.wikipedia.org/wiki/Finist%C3%A8re')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('30','91','Gard','GARD','5853','1790-03-04T12:00:00','Nimes','http://fr.wikipedia.org/wiki/Gard')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('34','91','Herault','HERAULT','6224','1790-03-04T12:00:00','Montpellier','http://fr.wikipedia.org/wiki/H%C3%A9rault_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('36','24','Indre','INDRE','6903','1790-03-04T12:00:00','Chateauroux','http://fr.wikipedia.org/wiki/Indre_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('38','82','Isere','ISERE','7431','1790-03-04T12:00:00','Grenoble','http://fr.wikipedia.org/wiki/Is%C3%A8re_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('42','82','Loire','LOIRE','4781','1793-08-12T12:00:00','St-Etienne','http://fr.wikipedia.org/wiki/Loire_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('45','24','Loiret','LOIRET','6775','1790-03-04T12:00:00','Orleans','http://fr.wikipedia.org/wiki/Loiret_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('48','91','Lozere','LOZERE','5167','1790-03-04T12:00:00','Mende','http://fr.wikipedia.org/wiki/Loz%C3%A8re_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('51','21','Marne','MARNE','8162','1790-03-04T12:00:00','Chalons-sur-Marne','http://fr.wikipedia.org/wiki/Marne_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('58','26','Nievre','NIEVRE','6817','1790-03-04T12:00:00','Nevers','http://fr.wikipedia.org/wiki/Ni%C3%A8vre_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('61','25','Orne','ORNE','6103','1790-03-04T12:00:00','Alencon','http://fr.wikipedia.org/wiki/Orne_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('64','72','Pyrenees Atlantiques','PYRENEES ATLANTIQUES','7645','1790-03-04T12:00:00','Pau','http://fr.wikipedia.org/wiki/Pyr%C3%A9n%C3%A9es-Atlantiques')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('65','73','Pyrenees (Hautes)','HAUTES PYRENEES','4464','1790-03-04T12:00:00','Tarbes','http://fr.wikipedia.org/wiki/Hautes-Pyr%C3%A9n%C3%A9es')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('66','91','Pyrenees Orientales','PYRENEES ORIENTALES','4116','1790-03-04T12:00:00','Perpignan','http://fr.wikipedia.org/wiki/Pyr%C3%A9n%C3%A9es-Orientales')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('69','82','Rhone','RHONE','3249','1793-08-12T12:00:00','Lyon','http://fr.wikipedia.org/wiki/Rh%C3%B4ne_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('70','43','Saone (Haute)','HAUTE SAONE','5360','1790-03-04T12:00:00','Vesoul','http://fr.wikipedia.org/wiki/Haute-Sa%C3%B4ne')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('71','26','Saone et Loire','SAONE ET LOIRE','8575','1790-03-04T12:00:00','Macon','http://fr.wikipedia.org/wiki/Sa%C3%B4ne-et-Loire')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('73','82','Savoie','SAVOIE','6028','1860-06-15T12:00:00','Chambery','http://fr.wikipedia.org/wiki/Savoie_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('79','54','Sevres (Deux)','DEUX SEVRES','5999','1790-03-04T12:00:00','Niort','http://fr.wikipedia.org/wiki/Deux-S%C3%A8vres')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('85','52','Vendee','VENDEE','6720','1790-03-04T12:00:00','La Roche-sur-Yon','http://fr.wikipedia.org/wiki/Vend%C3%A9e_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('88','41','Vosges','VOSGES','5874','1790-03-04T12:00:00','Epinal','http://fr.wikipedia.org/wiki/Vosges_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('94','11','Val de Marne','VAL DE MARNE','245','1968-01-01T12:00:00','Creteil','http://fr.wikipedia.org/wiki/Val-de-Marne')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('974','97','Reunion','REUNION','2512',Null,'Saint-Denis','http://fr.wikipedia.org/wiki/La_R%C3%A9union')");
    }
